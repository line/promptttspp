...
class GaussianDiffusion(nn.Module):
    ...
    def p_sample_plms(self, x, t, interval, cond):
        """
        Use the PLMS method from Pseudo Numerical Methods for
    ...
    def forward(self, cond, lengths=None, y=None, g=None, mask=None):
        ...
        x_recon = self.denoise_fn(x_noisy, t, cond, mask=mask)
    ...
    def inference(self, cond, lengths=None, g=None):
        ...
        t = self.K_step
        shape = (cond.shape[0], self.out_dim, cond.shape[2])
        ...
        x = self._denorm(x.transpose(1, 2))
        return x
